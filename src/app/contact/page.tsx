...
export default function ContactPage() {
  return (
    <>
      <section
        className="animate-fade-up w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center pt-10"
      ...
      <section id="form" className="animate-fade-up w-full max-w-2xl">
        <ContactForm />
      </section>
