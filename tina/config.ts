      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            ui: {
              description:
                'Project date for sorting on /work (e.g. "2026", "April 2024"). Newest/oldest toggle on the work page uses this field.',
            },
          },
          ...
          { type: "boolean", name: "featured", label: "Featured" },
          {
            ...
            ui: {
              description:
                "Tiebreaker when two projects share the same date (lower = higher). Main sort is by Date + Newest/Oldest on /work.",
            },
          },
          {
            type: "string",
