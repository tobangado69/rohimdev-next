...
export default function PrivacyPage() {
  const sections = [
    ...
    },
    {
      ...
      content: (
        <>
          I implement appropriate security measures to protect your personal information from unauthorized access, alteration, disclosure, or destruction. However, no method of transmission over the Internet or electronic storage is 100% secure, and I cannot guarantee absolute security.
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <ul className="list-disc list-inside mt-3 space-y-2 ml-4">
            ...
            <li>
              <strong>Analytical/Performance Cookies:</strong> Help me understand how visitors interact with my website
            </li>
            <li>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-white/80 leading-relaxed">
              At Rohim Dev, I am committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how I collect, use, and safeguard your data when you visit my website or engage my services.
            </p>
